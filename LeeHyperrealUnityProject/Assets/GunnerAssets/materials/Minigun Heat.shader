...
Shader "Minigun Heat"
{
	Properties
	{
		...
		_Vector0("Vector 0", Vector) = (1,1.24,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord8 = i.uv_texcoord * _Vector0 + temp_cast_3;
			float4 lerpResult46 = lerp( ( ( clampResult56 * _Heat2Color ) * tex2D( _Heat2, uv_TexCoord27 ) * _glowstrength ) , ( _Heat1Color * tex2D( _TextureSample0, uv_TexCoord8 ) * ( _glowstrength / 2.0 ) ) , float4( 0.5188679,0.5188679,0.5188679,1 ));
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.Vector2Node;28;-2841.625,275.4084;Inherit;False;Property;_Heat2offset;Heat 2 offset;5;0;Create;True;0;0;0;False;0;False;0.1,0;0.126,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;18;-2215.286,-837.3259;Inherit;False;Property;_Heat1offset;Heat 1 offset;4;0;Create;True;0;0;0;False;0;False;0.17,0;0.19,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;58;-2923.018,-191.1045;Inherit;False;Property;_HeatLength;Heat Length;12;0;Create;True;0;0;0;False;0;False;1;2.3;0;2.3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-2693.119,497.1726;Inherit;False;Property;_Heat2lengthmulti;Heat2 length multi;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-2511.611,-773.6138;Inherit;False;Property;_Heat1lengthmulti;Heat 1 length multi;15;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;49;-2349.314,-998.5154;Inherit;False;Property;_Vector0;Vector 0;10;0;Create;True;0;0;0;False;0;False;1,1.24;1.5,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;37;-2631.333,-13.43301;Inherit;False;Property;_Heat2Thickness;Heat 2 Thickness;8;0;Create;True;0;0;0;False;0;False;0,0;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;66;-2759.09,1100.474;Inherit;False;Property;_Heat3offset;Heat 3 offset;6;0;Create;True;0;0;0;False;0;False;0.1,0;0.05,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;65;-2611.584,1324.238;Inherit;False;Property;_heat3lengthmulti;heat 3 length multi;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-961.5037,-529.1151;Inherit;False;Property;_glowstrength;glow strength;11;0;Create;True;0;0;0;False;0;False;1;1;0;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-2122.598,-63.50102;Inherit;False;Property;_Heat2Color;Heat 2 Color;3;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;67;-2549.798,813.6329;Inherit;False;Property;_Heat3Thickness;Heat 3 Thickness;9;0;Create;True;0;0;0;False;0;False;0,0;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;7;-2321.99,-295.8142;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;cafd9192b69a7dd40b25e89c228ceae3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-2418.481,-645.4867;Inherit;False;Property;_Heat1Color;Heat 1 Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.7490196,0.1670133,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;70;-1402.879,911.3456;Inherit;False;Property;_Heat3Color;Heat 3 Color;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.7490196,0.7490196,0.7490196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-1917.704,328.2487;Inherit;True;Property;_Heat2;Heat 2;7;0;Create;True;0;0;0;False;0;False;-1;None;2352bca9943c85c4597e1272f7ee747d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;64;-1767.142,731.1827;Inherit;True;Property;_Heat3;Heat 3;16;0;Create;True;0;0;0;False;0;False;-1;None;2352bca9943c85c4597e1272f7ee747d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;77;-580.9918,115.169;Inherit;True;Property;_AlbedoMainTex;Albedo Main Tex;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;78;-589.906,320.6951;Inherit;False;Property;_Smoothness;Smoothness;18;0;Create;True;0;0;0;False;0;False;0;0;-2;2;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3CFDCF793C1950763D0CC0ADAB1EE34A97079A5C